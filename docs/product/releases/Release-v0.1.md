...
AI providers should be capable of reading and modifying project files after obtaining the appropriate permissions.
...
Version 0.1 does **not** replace the provider's permission model.
