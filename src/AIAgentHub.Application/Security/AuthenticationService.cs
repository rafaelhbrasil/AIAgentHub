...
public sealed class AuthenticationService : IAuthenticationService
{
    ...
    public AuthenticationService(IUserAccountRepository userRepository, IPasswordHasher passwordHasher)
    {
    ...
    {
        return await _userRepository.GetAdminAsync(cancellationToken);
    }
